...
### Task 1.2: The Feature Matrix

Construct the feature matrix X for a simple linear regression (include a column of 1s for the intercept). Verify the dimensions.
...
Compute H and verify that the fitted values $\hat{y}$ equal $Hy$.
...
Fit a regression with and without centering the response and predictor variables. Compare:
